...
\begin{table*}[t]
\caption{Total atomic energies (in Hartrees) calculated using the TF$\lambda$W kinetic energy functional combined with LDA, PBE, and FA exchange functionals. The columns correspond to specific values of $\lambda$: $1/9$, $1/6$, $1/5$, $1/3$, and $1.0$. The last column lists the reference RHF/UGBS values.}
